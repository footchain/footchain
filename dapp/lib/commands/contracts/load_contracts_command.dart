...
import 'package:dapp/commands/contracts/marketplace/load_marketplaceplayer_contract_command.dart';
...
class LoadContractsCommand extends BaseCommand {
  Future execute(provider) async {
    ...
    await LoadMarketplacePlayerV1ContractCommand().execute(provider);
